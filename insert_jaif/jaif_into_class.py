...
def find_or_download_tools():
    if not os.path.isdir(annotation_tools):
        ...
        urllib.urlretrieve(
            "http://types.cs.washington.edu/annotation-file-utilities/current/annotation-tools-3.6.27.zip",
            annotation_tools_zip)
...
def test():
    test_java = os.path.join(annotation_tools,
                             "annotation-file-utilities/tests/MethodMultiple.java")
    test_jaif = os.path.join(annotation_tools,
                             "annotation-file-utilities/tests/MethodMultiple.jaif")
